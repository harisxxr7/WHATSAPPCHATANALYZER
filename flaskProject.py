...
def dashboard():
    ...
    if request.method == 'POST':
        ...
        if uploaded_file.filename != '':
            folder_path = r'C:\\Users\\Shery\\PycharmProjects\\WhatsAppData\\textfile\\file1.txt'
            delete_folder_contents(r'C:\\Users\\Shery\\PycharmProjects\\WhatsAppData\\textfile')
...
def Chat_Comparsion():
    if request.method == 'POST':
        ...
        if uploaded_file.filename != '' and uploaded_file1.filename != '':
            folder_path = r'C:\\Users\\Shery\\PycharmProjects\\WhatsAppData\\compare\\file.txt'
            folder_path1 = r'C:\\Users\\Shery\\PycharmProjects\\WhatsAppData\\compare\\file1.txt'
            delete_folder_contents(r'C:\\Users\\Shery\\PycharmProjects\\WhatsAppData\\compare')
            uploaded_file.save(folder_path)
